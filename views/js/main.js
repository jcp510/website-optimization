...
// resizePizzas(size) is called when the slider in the "Our Pizzas" section of the
// website moves.
...
/* Remove pizzasDiv from, and cache outside of for-loop, so that DOM is not accessed
   on each iteration. */
